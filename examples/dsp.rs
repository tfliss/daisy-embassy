...
// Note: remainder_f32 and rint_f32 functions removed as they require libm
// which is not available in embedded no_std environments
...
impl Volumecontrol {
    ...
    pub fn compute(
        ...
        let mut fSlow0: F32 = self.fConst1 * F32Ext::powf(1e+01, 0.05 * self.fVslider0);
